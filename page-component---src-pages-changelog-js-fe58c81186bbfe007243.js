...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Entry = function Entry(_ref) {
	  var title = _ref.title,
	      ...
	      toggle = _ref.toggle,
	      props = _objectWithoutProperties(_ref, ['title', 'content', 'collapse', 'toggle']);
	...
	var Changelog = function (_React$Component) {
	  ...
	  function Changelog(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, (Changelog.__proto__ || Object.getPrototypeOf(Changelog)).call(this, props));
	
	    _this.toggle = _this.toggle.bind(_this);
	    _this.state = { collapseId: null };
	    return _this;
	  }
	  ...
	  _createClass(Changelog, [{
	    ...
	    value: function render() {
	      ...
	      var entries = this.props.data.allChangelog.edges;
	      return _react2.default.createElement(
	        'div',
	        { className: 'container pt-5' },
	        entries.map(function (entry, i) {
	          return _react2.default.createElement(Entry, _extends({}, entry.node, {
	            key: i,
	            collapse: _this2.state.collapseId == i,
...
//# sourceMappingURL=page-component---src-pages-changelog-js-fe58c81186bbfe007243.js.map